...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'thinkideas_storelocator/tmp/stockist/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'thinkideas_storelocator/stockist/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'thinkideas_storelocator/tmp/stockist/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'thinkideas_storelocator/stockist/file';
