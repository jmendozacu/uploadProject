 ...
 */
namespace ThinkIdeas\Storelocator\Model\ResourceModel;
...
use ThinkIdeas\Storelocator\Model\Stores as StockistModel;
use Magento\Framework\Event\ManagerInterface;

class Stores extends AbstractDb
{
    const TBL_ATT_PRODUCT = 'thinkideas_storelocator_products';
    ...
    {
        $this->_init('thinkideas_storelocator_stores', 'stockist_id');
    }
    ...
    public function _beforeDelete(AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('thinkideas_storelocator_stores'), $condition);
     ...
     *
     * @param AbstractModel|\ThinkIdeas\Storelocator\Model\Stores $object
     * @return $this
     */
