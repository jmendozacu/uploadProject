 ...
 */
namespace ThinkIdeas\Storelocator\Model\ResourceModel\Stores;
...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    public $_eventPrefix = 'thinkideas_storelocator_stores_collection';
    ...
    public function performAfterLoad($tableName, $linkField)
    {
        ...
        if (count($linkedIds)) {
            ...
            $select = $connection->select()->from(['thinkideas_storelocator_stores' => $this->getTable($tableName)])
                ->where('thinkideas_storelocator_stores.' . $linkField . ' IN (?)', $linkedIds);
