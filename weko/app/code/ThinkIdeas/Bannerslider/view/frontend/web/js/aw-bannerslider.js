    ...
    $.widget('mage.awBannerslider', {
        ...
        resizeBanner: function(slideshow) {
            ...
            if (slideshow.slides.length) {
                width = $(slideshow.slides[0]).find('img.aw-bannerslider__img').prop('naturalWidth');
                slideshow.slides.each(function () {
                    width = Math.min(width, $(this).find('img.aw-bannerslider__img').prop('naturalWidth'));
                });
            }
