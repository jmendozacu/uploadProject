...
namespace ThinkIdeas\Bannerslider\Block\Adminhtml\Banner\Edit\Tab\Grid;

use Magento\Backend\Block\Widget\Grid;
use Magento\Backend\Block\Widget\Grid\Column;
use Magento\Backend\Block\Widget\Grid\Extended as GridExtended;
use ThinkIdeas\Bannerslider\Model\Source\Status;
use ThinkIdeas\Bannerslider\Model\Source\CustomerGroups;
use ThinkIdeas\Bannerslider\Model\ResourceModel\Banner\Collection as BannerCollection;
use ThinkIdeas\Bannerslider\Model\ResourceModel\Slide\Collection as SlideCollection;
use ThinkIdeas\Bannerslider\Block\Adminhtml\Banner\Edit\Tab\Grid\Column\Renderer;
...
/**
 * Class Slide
 * @package ThinkIdeas\Bannerslider\Block\Adminhtml\Banner\Edit\Tab\Grid
...
class Slide extends GridExtended
{
    ...
    {
        return $this->getUrl('aw_bannerslider_admin/*/grid', ['_current' => true]);
    }
    ...
    {
        $formData = [];
        if (!empty($this->dataPersistor->get('aw_bannerslider_banner'))) {
            $formData = $this->dataObjectFactory->create(
                $this->dataPersistor->get('aw_bannerslider_banner')
            );
