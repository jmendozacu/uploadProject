...
namespace ThinkIdeas\Bannerslider\Block\Adminhtml\Banner\Widget;
...
/**
 * Class Chooser
 * @package ThinkIdeas\Bannerslider\Block\Adminhtml\Banner\Widget
 */
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function prepareElementHtml(AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl('aw_bannerslider_admin/banner_widget/chooser', ['uniq_id' => $uniqId]);
    ...
    {
        return $this->getUrl('aw_bannerslider_admin/banner_widget/chooser', ['_current' => true]);
    }
}
