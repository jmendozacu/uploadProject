...
namespace ThinkIdeas\Bannerslider\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package ThinkIdeas\Bannerslider\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'ThinkIdeas_Bannerslider::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \ThinkIdeas\Bannerslider\Block\Adminhtml\Page\Menu $menu */
