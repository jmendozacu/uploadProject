...
namespace ThinkIdeas\Bannerslider\Model\ResourceModel\Statistic;

use ThinkIdeas\Bannerslider\Model\Statistic;
...
/**
 * Class Collection
 * @package ThinkIdeas\Bannerslider\Model\ResourceModel\Statistic
 */
class Collection extends AbstractCollection
{
    ...
    protected function _initSelect()
    {
        ...
        $ctrQuery = $this->getConnection()->select()
            ->from(
                [$this->getTable('aw_bannerslider_statistic')],
    ...
    {
        $this->joinLinkageTable('aw_bannerslider_slide_banner', 'slide_banner_id', 'id', 'banner_id');
        $this->joinLinkageTable('aw_bannerslider_slide_banner', 'slide_banner_id', 'id', 'slide_id');
        $this->joinNameField('slide_name', 'aw_bannerslider_slide', 'slide_id');
        $this->joinNameField('banner_name', 'aw_bannerslider_banner', 'banner_id');
    ...
    private function attachSlideBanner()
    {
        ...
        $select = $connection->select()
            ->from(
                ['sb' => $this->getTable('aw_bannerslider_slide_banner')],
                []
            )->joinLeft(
                ['s' => $this->getTable('aw_bannerslider_slide')],
                'sb.slide_id = s.id',
                [
                    'slide_id' => 'id',
                    'slide_name' => 'name',
                ...
                ['b' => $this->getTable('aw_bannerslider_banner')],
                'sb.banner_id = b.id',
                [
                    'banner_id' => 'id',
                    'banner_name' => 'name'
    ...
    private function joinNameField($fieldName, $tableName, $linkageColumnName)
    {
        if (array_key_exists($fieldName, $this->_orders)) {
            $this->getSelect()
                ->joinLeft(
                    [$fieldName . '_sb' => $this->getTable('aw_bannerslider_slide_banner')],
