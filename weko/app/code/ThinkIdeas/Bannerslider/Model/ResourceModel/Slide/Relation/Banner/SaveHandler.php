...
namespace ThinkIdeas\Bannerslider\Model\ResourceModel\Slide\Relation\Banner;
 ...
 * Class SaveHandler
 *
 * @package ThinkIdeas\Bannerslider\Model\ResourceModel\Slide\Relation\Banner
 */
class SaveHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $tableName = $this->resourceConnection->getTableName('aw_bannerslider_slide_banner');
        ...
        if (count($toInsert)) {
            foreach ($toInsert as $bannerId) {
                ...
                $connection->insert(
                    $this->resourceConnection->getTableName('aw_bannerslider_statistic'),
    ...
    private function getBannerIds($entityId)
    {
        ...
        $select = $connection->select()
            ->from($this->resourceConnection->getTableName('aw_bannerslider_slide_banner'), ['banner_id'])
            ->where('slide_id = :id');
