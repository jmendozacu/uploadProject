...
namespace ThinkIdeas\Bannerslider\Model\ResourceModel\Slide;
...
/**
 * Class Collection
 * @package ThinkIdeas\Bannerslider\Model\ResourceModel\Slide
 */
class Collection extends AbstractCollection
{
    ...
    public function joinPositions($bannerId)
    {
        if (!$this->getFlag('slide_positions_joined')) {
            $this->getSelect()->joinLeft(
                ['pos' => $this->getTable('aw_bannerslider_slide_banner')],
    ...
    {
        $this->attachRelationTable('aw_bannerslider_slide_banner', 'id', 'slide_id', 'banner_id', 'banner_ids');
        $this->attachRelationTable('aw_bannerslider_slide_store', 'id', 'slide_id', 'store_id', 'store_ids');
    ...
    {
        $this->joinLinkageTable('aw_bannerslider_slide_banner', 'id', 'slide_id', 'banner_id');
        $this->joinLinkageTable('aw_bannerslider_slide_store', 'id', 'slide_id', 'store_id');
        $this->joinLinkageTable('aw_bannerslider_slide_customer_group', 'id', 'slide_id', 'customer_group_id');
