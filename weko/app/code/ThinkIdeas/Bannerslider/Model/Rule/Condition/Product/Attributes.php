...
namespace ThinkIdeas\Bannerslider\Model\Rule\Condition\Product;
 ...
 * Class Attributes
 *
 * @package ThinkIdeas\Bannerslider\Model\Rule\Condition\Product
...
class Attributes extends \Magento\Rule\Model\Condition\Product\AbstractProduct
{
    ...
    public function collectValidatedAttributes($productCollection)
    {
        ...
        if ($attribute->getAttributeCode() == 'category_ids') {
            if (!$productCollection->getFlag('aw_bannerslider_collection_category_joined')) {
                ...
                $productCollection->setFlag('aw_bannerslider_collection_category_joined', true);
            }
        } else {
            if ($attribute->isStatic()) {
                ...
                if (!$productCollection->getFlag("aw_bannerslider_{$tableAlias}_joined")) {
                    $productCollection
                        ->getSelect()
                        ->joinLeft(
                            [$tableAlias => $table],
                    ...
                    ;
                    $productCollection->setFlag("aw_bannerslider_{$tableAlias}_joined", true);
                }
                $conditions = [];
