...
namespace ThinkIdeas\Bannerslider\Test\Unit\Controller\Adminhtml\Banner;

use ThinkIdeas\Bannerslider\Model\Source\PageType;
use Magento\Backend\App\Action\Context;
use ThinkIdeas\Bannerslider\Api\BannerRepositoryInterface;
use ThinkIdeas\Bannerslider\Controller\Adminhtml\Banner\Save;
...
/**
 * Test for \ThinkIdeas\Bannerslider\Controller\Adminhtml\Banner\Save
 *
...
class SaveTest extends \PHPUnit_Framework_TestCase
{
    ...
    private $formData = [
        ...
        'rule' => [
            'bannerslider' => [
                '1' => [
                    'type' => 'ThinkIdeas\Bannerslider\Model\Rule\Condition\Combine',
                    'aggregator' => 'all',
                    'value' => '1',
                    'new_child' => ''
                ],
                '1--1' =>[
                    'type' => 'ThinkIdeas\Bannerslider\Model\Rule\Condition\Product\Attributes',
