...
use ThinkIdeas\Bannerslider\Block\Banner;
...
/**
 * Test for \ThinkIdeas\Bannerslider\Block\Banner
...
class BannerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $impPath = 'https://ecommerce.thinkIdeas.com/pub/media/aw_bannerslider/slides/';
    ...
    public function getSlideImgUrlDataProvider()
    {
        return [
            [
                ...
                '1.png',
                '',
                'https://ecommerce.thinkIdeas.com/pub/media/aw_bannerslider/slides/1.png'
            ],
            [
                ImageType::TYPE_URL,
                '',
                'https://ecommerce.thinkIdeas.com/my_img.png',
                'https://ecommerce.thinkIdeas.com/my_img.png'
            ]
        ];
    }
    ...
    {
        $expected = 'https://ecommerce.thinkIdeas.com/aw_bannerslider/countClicks/redirect/'.$slideId.'/'.$bannerId;
