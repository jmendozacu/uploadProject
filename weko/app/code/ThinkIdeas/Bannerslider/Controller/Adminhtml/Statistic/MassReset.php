...
namespace ThinkIdeas\Bannerslider\Controller\Adminhtml\Statistic;
...
/**
 * Class MassReset
 * @package ThinkIdeas\Bannerslider\Controller\Adminhtml\Statistic
 */
class MassReset extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'ThinkIdeas_Bannerslider::statistics';
