...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('ThinkIdeas_Returnrequest::Returnrequest')
                ->addBreadcrumb(__('ThinkIdeas Returnrequest'), __('ThinkIdeas Returnrequest'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('returnrequest', $model);
        ...
        $resultPage->addBreadcrumb(
                $id ? __('Edit Item') : __('New Item'), $id ? __('Edit Item') : __('New Item')
        );
