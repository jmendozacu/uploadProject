...
class ExportExcel extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $exportBlock = $this->_view->getLayout()->createBlock('ThinkIdeas\Returnrequest\Block\Adminhtml\Returnrequest\Grid');
        ...
        return $this->_fileFactory->create(
                        $fileName, $exportBlock->getExcelFile(), DirectoryList::VAR_DIR
        );
    }
