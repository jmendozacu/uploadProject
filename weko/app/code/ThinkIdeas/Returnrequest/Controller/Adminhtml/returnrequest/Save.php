...
//            }
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The Returnrequest has been saved.'));
                $this->_objectManager->get('Magento\Backend\Model\Session')->setFormData(false);
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['rr_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['rr_id' => $this->getRequest()->getParam('rr_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
