...
namespace ThinkIdeas\Linkedproducts\Setup;
...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $data = [
            ['link_type_id' => \ThinkIdeas\Linkedproducts\Model\Catalog\Product\Link::LINK_TYPE_CUSTOMTYPE, 'code' => 'customtype']
        ];
        ...
        $data = [
            [
                'link_type_id' => \ThinkIdeas\Linkedproducts\Model\Catalog\Product\Link::LINK_TYPE_CUSTOMTYPE,
