...
namespace ThinkIdeas\Linkedproducts\Ui\DataProvider\Product\Form\Modifier;
...
class Related extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\Related
{
            ...
            [
                static::GROUP_RELATED => [
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'label' => __('Related Products, Up-Sells, Cross-Sells and Custom Selected'),
                                'collapsible' => true,
    ...
    {
        $content = __(
            'Custom selected products are shown to customers in addition to the item the customer is looking at.'
        );
        ...
        return [
            'children' => [
                'button_set' => $this->getButtonSet(
                    $content,
                    __('Add Custom selected Products'),
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => __('Custom selected Products'),
                        'collapsible' => false,
                        'componentType' => Fieldset::NAME,
                        'dataScope' => '',
                        'sortOrder' => 90,
