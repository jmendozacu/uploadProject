...
namespace ThinkIdeas\Linkedproducts\Block\Adminhtml\Catalog\Product\Edit\Tab;

use Magento\Backend\Block\Widget\Grid\Column;
use Magento\Backend\Block\Widget\Grid\Extended;
use Magento\Catalog\Model\Product;

class Customtype extends Extended
{
    /**
     * Core registry
     *
    ...
    {
        parent::_construct();
        $this->setId('customtype_product_grid');
    ...
    {
        return $this->getProduct() && $this->getProduct()->getCustomtypeReadonly();
    }
    ...
    public function getGridUrl()
    {
        return $this->getData(
            ...
            'catalog/*/customtypeGrid',
            ['_current' => true]
        );
    }

    /**
     * Retrieve selected custom type products
     *
     * @return array
     */
    protected function _getSelectedProducts()
    {
        $products = $this->getProductsCustomtype();
        if (!is_array($products)) {
            $products = array_keys($this->getSelectedCustomtypeProducts());
        }
        return $products;
    }

    /**
     * Retrieve Custom type products
     *
     * @return array
     */
    public function getSelectedCustomtypeProducts()
    {
        $products = [];
        foreach ($this->_coreRegistry->registry('current_product')->getCustomtypeProducts() as $product) {
    ...
    /**
     * Apply `position` filter to custom type grid.
     *
