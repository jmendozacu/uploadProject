...
namespace ThinkIdeas\Productslider\Model;

/**
 * Productslider model
 * @package ThinkIdeas\Productslider\Model
 */
class Productslider extends \Magento\Framework\Model\AbstractModel {
    ...
    const SLIDER_TYPE_BESTSELLERS_MANUAL = 'bestsellers_manual';
    ...
    {
        $this->_init('ThinkIdeas\Productslider\Model\ResourceModel\Productslider');
    }
    ...
    protected static $sliderTypes = [
        ...
        self::SLIDER_TYPE_BESTSELLERS_MANUAL => 'Bestselers Manual Products',
