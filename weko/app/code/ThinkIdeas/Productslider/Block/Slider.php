...
namespace ThinkIdeas\Productslider\Block;

use ThinkIdeas\Productslider\Model\Productslider;
...
class Slider extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface {
     ...
     */
    protected $_template = 'ThinkIdeas_Productslider::slider.phtml';

    /**
     * Product slider collection factory
     *
     * @var \ThinkIdeas\Productslider\Model\ResourceModel\Productslider\CollectionFactory
     */
     ...
     * @param \ThinkIdeas\Productslider\Model\ResourceModel\Productslider\CollectionFactory $sliderCollectionFactory
     * @param \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \ThinkIdeas\Productslider\Model\ResourceModel\Productslider\CollectionFactory $sliderCollectionFactory,
        array $data = []
    ){
     ...
     *
     * @param \ThinkIdeas\Productslider\Model\ResourceModel\Productslider\Collection $sliderCollection
     *
     * @return $this
     */
    public function setSlider($sliderCollection)
    {
        ...
        foreach($sliderCollection as $slider):
            $this->append($this->getLayout()
                                ->createBlock('\ThinkIdeas\Productslider\Block\Slider\Items')
                                ->setSlider($slider));
        endforeach;
