...
namespace ThinkIdeas\Productslider\Block\Adminhtml\Block\Widget;
...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \ThinkIdeas\Productslider\Model\ResourceModel\Productslider\CollectionFactory $collectionFactory
     * @param array $data
     */
    public function __construct(
        ...
        \ThinkIdeas\Productslider\Model\ResourceModel\Productslider\CollectionFactory $collectionFactory,
        array $data = []
    ) {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'type',
                'type' => 'options',
                'options' => \ThinkIdeas\Productslider\Model\Productslider::getSliderTypeArray()
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'location',
                'type' => 'options',
                'options' => \ThinkIdeas\Productslider\Model\Productslider::getSliderGridLocations()
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'status',
                'type' => 'options',
                'options' => \ThinkIdeas\Productslider\Model\Productslider::getStatusArray()
            ]
        );
