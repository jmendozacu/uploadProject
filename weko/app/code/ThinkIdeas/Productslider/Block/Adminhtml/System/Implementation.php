...
namespace ThinkIdeas\Productslider\Block\Adminhtml\System;
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        $html = '<div class="notices-wrapper">
                    ...
                    <div class="message">
                        ...
                        echo $this->getLayout()->createBlock("ThinkIdeas\Productslider\Block\Slider\Items")->setSliderId("custom_slider_id")->toHtml();
                    </div>
                    <div class="message">
                        <strong>'.__('Copy code from below to the CMS page or block and replace custom_slider_id with proper slider id').'</strong><br/>
                        {{block class="ThinkIdeas\Productslider\Block\Slider\Items" slider_id="custom_slider_id"}}
                    </div>
                    <div class="message">
                        <strong>'.__('Copy code from below to the layout XML file and replace custom_slider_id with proper slider id').'</strong><br/>
                        &lt;block class="ThinkIdeas\Productslider\Block\Slider\Items"&gt;<br/>
