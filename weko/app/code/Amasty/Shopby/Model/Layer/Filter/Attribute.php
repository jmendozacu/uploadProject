...
class Attribute extends AbstractFilter
{
    ...
    {
        if ($this->isApplied() && !$this->scopeConfig->isSetFlag('amshopby/general/keep_single_choice_visible', \Magento\Store\Model\ScopeInterface::SCOPE_STORE) && !$this->isMultiselectAllowed()) {
            return [];
        }
