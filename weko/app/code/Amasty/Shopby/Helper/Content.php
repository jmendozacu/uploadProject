...
class Content extends AbstractHelper implements CategoryDataSetterInterface
{
    ...
    public function __construct(
        ...
        $this->_headingApplyAll = in_array($allAttributes, explode(',', $this->_settings['heading']['apply_to']));
        $this->_metaApplyAll = in_array($allAttributes, explode(',', $this->_settings['meta']['apply_to']));
    }
    ...
    protected function _applyFilters()
    {
        ...
        foreach ($this->_filterList->getFilters($this->_layer) as $filter) {
