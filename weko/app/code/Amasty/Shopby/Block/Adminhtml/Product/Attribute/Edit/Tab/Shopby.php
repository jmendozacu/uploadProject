...
class Shopby extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->_eventManager->dispatch('amshopby_attribute_form_tab_build_after', ['form' => $form, 'setting' => $this->setting, 'dependence' => $dependence]);
    ...
    protected function addCategorySettingFields(Fieldset $fieldsetDisplayProperties, Dependence $dependence, $displayModeField)
    {
