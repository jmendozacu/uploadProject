...
class Router implements \Magento\Framework\App\RouterInterface
{
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        if ($this->moduleManager->isEnabled('Amasty_ShopbyBrand')) {
            $urlKey = $this->scopeConfig->getValue('amshopby_brand/general/url_key', ScopeInterface::SCOPE_STORE);
        ...
        if ($this->moduleManager->isEnabled('Amasty_ShopbySeo') && $this->scopeConfig->getValue('amasty_shopby_seo/url/mode', ScopeInterface::SCOPE_STORE)) {
