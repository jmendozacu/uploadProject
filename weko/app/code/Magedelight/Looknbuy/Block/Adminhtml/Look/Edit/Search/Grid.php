...
namespace Magedelight\Looknbuy\Block\Adminhtml\Look\Edit\Search;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('product_selection_search_grid');
...
//        $this->setRowInitCallback('pbSelection.productGridRowInit.bind(pbSelection)');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'price',
                'renderer' => 'Magedelight\Looknbuy\Block\Adminhtml\Look\Edit\Search\Grid\Renderer\Price',
            ]
        );
    ...
    public function getGridUrl()
    {
        return $this->getUrl(
            'looknbuy/*/loadblock',
            ['block' => 'product_grid', 'index' => $this->getIndex(), '_current' => true, 'collapse' => null]
        );
    }
