...
class Toplink extends \Magento\Framework\View\Element\Html\Link
{
    ...
    protected $_template = 'Magedelight_Looknbuy::link.phtml';
    ...
    {
        $storeScope = \Magento\Store\Model\ScopeInterface::SCOPE_STORE;
        $label = $this->scopeConfig->getValue('looknbuy/general/link_title', $storeScope);
    ...
    protected function _toHtml()
    {
        ...
        $top_enable = $this->scopeConfig->getValue('looknbuy/general/enabled_look_on', $storeScope) == 'toplink' ? true : false;
