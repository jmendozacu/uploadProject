...
namespace Magedelight\Looknbuy\Controller\Cart;
...
class Add extends \Magento\Checkout\Controller\Cart\Add
{
    ...
    public function getQuote()
    {
        if (!$this->cart->hasData('quote')) {
            $this->cart->setData('quote', $this->_checkoutSession->getQuote());
        }

        return $this->cart->_getData('quote');
    ...
    protected function _getProductsAndQtys($lookId)
    {
        $qtyArray = array();
        $this->_objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $bundle = $this->_objectManager->create('Magedelight\Looknbuy\Model\Looknbuy')->load($bundleId);
